...
import ma.ensa.volley.EtudiantActivity;
import ma.ensa.volley.R;
import ma.ensa.volley.UpdateEtudiantActivity;
...
public class EtudiantAdapter extends RecyclerView.Adapter<EtudiantAdapter.EtudiantViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull EtudiantViewHolder starViewHolder, @SuppressLint("RecyclerView") int i) {
    ...
    private void deleteStudent(String id) {
        ...
        String deleteUrl = "http://192.168.89.73:8080/api/student/"+id;
    ...
    public void loadEtudiants(){
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://192.168.89.73:8080/api/student",
