...
public class FiliereAdapter extends RecyclerView.Adapter<FiliereAdapter.FiliereViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull FiliereViewHolder starViewHolder, @SuppressLint("RecyclerView") int i) {
    ...
    private void deleteFiliere(String id) {
        ...
        String deleteUrl = "http://192.168.89.73:8080/api/v1/filieres/"+id;
    ...
    public void loadFilieres(){
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://192.168.89.73:8080/api/v1/filieres",
